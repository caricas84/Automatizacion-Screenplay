...
public class DataTableSchedule {
    ...
    public void setDocumentNumberPatient(String documentNumberPatient) {
        this.documentNumberPatient = documentNumberPatient;
    }
    ...
    public void setDocumentNumberDoctor(String documentNumberDoctor) {
        this.documentNumberDoctor = documentNumberDoctor;
    }
